...
class openMLDB_sql_generator():
    def __init__(self, target, train_name, test_name, path, time_series=False, ts_unit=None, time_col=None,
                 ...
                 Debug=False, image_info={}, target_map={},output_file_path="/tmp/",table_info_dict={},table_list=[],window_list=[]):
        self.Debug = Debug
        self.info_ = {}
        self.info_['id'] = id
        ...
        self.info_['window_list']=window_list
    ...
    def time_series_feature_sql(self):
        ...
        self.window_list=self.info_['window_list']
...
if __name__ == '__main__':
    ...
    relation_dict=[    # 表关系(可以包含为1-1, 1-M, M-1, M-M四种)
        {
            ...
            "left_entity": "t1",
            "left_on": ["id"],
            "left_time_col": "pickup_datetime",
            "right_entity": "t3",
            "right_on": ["id"],
            "right_time_col": "pickup_datetime",
            "type": "1-M"
        },
        {
    ...
    myOpenMLDB_sql_generator = openMLDB_sql_generator(target=target_column_name, train_name='train2.csv',
                                                      ...
                                                      feature_type=feature_type,output_file_path=output_file_path,table_info_dict=table_info_dict,table_list=table_list,window_list=window_list)
